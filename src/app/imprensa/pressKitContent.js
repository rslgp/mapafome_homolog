...
export const FACTS = [
  ...
  ['Fundador', 'Rafael Leão, criador do MAPA FOME. O projeto teve origem em 2022, durante a graduação em Ciência da Computação no CIn UFPE; formado em 2025, hoje é engenheiro de software (especializado em inovação, MVP e User Requirements).'],
