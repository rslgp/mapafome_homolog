...
{/* https://www.arcgis.com/apps/mapviewer/index.html */}
    ...
    setupVariables(mapCoords,DateISO,Telefone,Avaliacao){
        ...
        if(Telefone){
            ...
            let legivelTelefone = Telefone.replace ? Telefone.replace(/(\d{2})(\d{5})(\d{4})/g, "($1) $2-$3") : 'TEL_PROB';
            let contato="contato:";
