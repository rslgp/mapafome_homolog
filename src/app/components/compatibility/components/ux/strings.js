...
const DICT = {
  'pt-BR': {
    ...
    'pets.filter.count.noneMatch': 'Nenhum pet combina com o filtro. Tente afrouxar a busca.',
  ...
  'es': {
    ...
    'pets.filter.count.noneMatch': 'Ninguna mascota coincide con el filtro. Prueba a aflojar la búsqueda.',
