...
> **LAST_UPDATED:** 2026-07-09 · branch `loop/mapafome` · **ONDA 1+2 IMPLEMENTADA E SHIPPED** (7 commits atomicos e39cf61..d4f857a, gate 100% verde LIDO: lint/test 1433/fitness/build/smoke200 16-16/backend 112). 6 fixes: EXT-DBLSUBMIT-01 (S+, guard double-submit no botao de publicar fome), EXT-READROW-01 (S, parse por-linha resiliente), EXT-CSV-01 (S-, formula-injection), EXT-TIMEOUT-01+FORM-01 (S-, timeout+telefone na doacao), EXT-SEC-04 (S-, rate-limit per-IP), EXT-EH-05 (S-, sem ghost pin). +1 chore(fitness) re-ancorou o FF2 baseline (App.js:136->:133, deslocado pela sessao concorrente). EXT-REP2-01 confirmado ja-shipped (af3b693). Estado: **168 itens/89 areas · shipped 9 / pending 137**. Proximo: ONDA 3 (a11y/i18n ultimo-metro) — ver PRIORIDADES.md.
...
- **168 milestones** em **89 areas** · pending **137** · blocked-human **19** · later **3** (cross-refs) · **shipped 9**. Validado via parser YAML: 0 ids duplicados.
