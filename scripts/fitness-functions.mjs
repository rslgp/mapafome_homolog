...
const FF2_BASELINE = new Set([
    ...
    'src/app/components/compatibility/components/ux/NotificationPrefs.js:45',   // NotificationPrefs (112; +EXT-URLSTATE-01 back-to-close hook; refreshed anchor 44->45)
    'src/app/components/compatibility/components/ux/PinDetailSheet.js:84',      // PinDetailSheet (234; +UX-M35 share handler + button, thin donor-response render)
    'src/app/components/compatibility/components/ux/ReportSheet.js:29',         // ReportSheet (310; +EXT-URLSTATE-01 back-to-close hook; refreshed anchor 28->29)
