...
const FF2_BASELINE = new Set([
    ...
    'src/app/components/compatibility/components/ux/InstallToast.js:82',         // InstallToast (272; +UX-M34 earn-gate helpers, still one cohesive component)
    'src/app/components/compatibility/components/ux/NotificationPrefs.js:46',   // NotificationPrefs (120; +EXT-FOCUSTRAP-01 useFocusTrap wiring; refreshed anchor 45->46)
    'src/app/components/compatibility/components/ux/PinDetailSheet.js:85',      // PinDetailSheet (242; +EXT-FOCUSTRAP-01 useFocusTrap wiring; refreshed anchor 84->85)
    'src/app/components/compatibility/components/ux/ReportSheet.js:30',         // ReportSheet (317; +EXT-FOCUSTRAP-01 useFocusTrap wiring; refreshed anchor 29->30)
